...
1. working
   - the style and layout of map and bottom tab **not start**
2. self-study
   - leetcode 1 + the basic knowledge of binary tree  **done**
   - data structure and algorithms 5.6-5.9 **unfinished**
   - restful api  **not start**
   - IELTS  **not start**
     - reading
     - writing
     ...
     - speaking
3. why not finished
   - the learning passion decayed
   - obsessed with cleaning machine and tennis racket
   - lack of sleep
...
2. self-study
   - leetcode 2  **done**
   - data structure and algorithms 6.7-6.8 **not start**
   - the source code of what I've learned about js  **not start**
   - IELTS  **not start**
     - reading practice 2
     - listening 课程
3. why not finished
   - tapped into a leetcode;
   - need to have a balance between study and rest in weekend
     - cleaning at Friday night
     - rest and study in weekend
       - better go to library
